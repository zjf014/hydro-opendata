...
class Alos_DEM:
    ...
    def __init__(self):
        self._sources = {
            'microsoft':{'url':'https://planetarycomputer.microsoft.com/api/stac/v1/','collection_name':'alos-dem'},
        }
        self._hrefs=[]
    ...
    def search(self, source='microsoft', bbox=[115,38,136,54], intersects=None):
        '''
