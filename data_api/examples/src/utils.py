...
def _central_pixel_bbox(
    ...
    return (polygon, polygon_latlon, utm_coords, epsg)
...
def from_latlon(
    ...
    polygon, polygon_latlon, utm_coords, epsg = _central_pixel_bbox(lat, lon, edge_size, resolution)
...
def from_points(
    ...
    epsg = None
    for point in points:
        polygon, polygon_latlon,utm_coords, epsg = _central_pixel_bbox(point[1], point[0], edge_size, resolution)
        polygons.append([polygon])
        polygon_latlons.append([polygon_latlon])
